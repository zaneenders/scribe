        ...
        "profiles": [
          {
            ...
            "agent": { "model": "model-alpha", "contextWindow": 4000, "contextWindowThreshold": 0.75, "reasoningEfforts": ["low", "medium", "high"] },
            "logging": { "level": "trace" }
          },
          {
            "name": "beta",
            "api": { "baseUrl": "http://test", "apiKey": "" },
            "agent": { "model": "model-beta", "contextWindow": 4000, "contextWindowThreshold": 0.75, "reasoningEfforts": ["minimal", "medium", "xhigh"] },
            "logging": { "level": "trace" }
          }
        ]
      }
