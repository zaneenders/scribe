...
struct MarkdownRendererTests {
    ...
    @Test func manyConsecutiveBlankLines() {
        ...
        let lines = render(md)
        #expect(lines.allSatisfy { $0.spans.allSatisfy { $0.text.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty } })
    }
